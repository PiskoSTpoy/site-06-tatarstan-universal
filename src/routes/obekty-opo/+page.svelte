...
<main>
	...
	<section class="section wrap prose" style="padding-top:0;max-width:840px">
		...
		<p style="margin-top:24px">
			...
			<a href="/formy/" style="color:var(--accent)">«Формы и бланки»</a>. Если по итогу на объект нужен не
			автокран и не гусеничный кран, а другой вид техники — башенный кран, манипулятор, экскаватор и так
			далее, — маршрут заявки описан в разделе
			<a href="/partnerskaya-set/" style="color:var(--accent)">«Партнёрская сеть»</a>.
		</p>
