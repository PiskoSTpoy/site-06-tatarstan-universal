<script lang="ts">
	...
	// После волны 39 в блоге 10 статей о том, что определяет дату выезда техники на объект: девять
	...
	// культурного наследия) и одна про допуск на дорогу к ней (спецразрешение) — блок
