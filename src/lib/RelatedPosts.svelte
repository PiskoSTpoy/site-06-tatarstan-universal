<script lang="ts">
	...
	// После волны 38 в блоге 9 статей о том, что определяет дату выезда крана на объект: восемь про
	// наряд-допуск или разрешение на площадку (газоопасная зона, работа у ЛЭП, охранная зона
	// газопровода, периметр ОЭЗ «Алабуга», приаэродромная территория) и одна про допуск на дорогу к
	// ней (спецразрешение) — блок
