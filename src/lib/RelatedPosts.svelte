<script lang="ts">
	...
	// После волны 40 в блоге 11 статей о том, что определяет дату выезда техники на объект: десять
	...
	// культурного наследия, охранная зона железной дороги) и одна про допуск на дорогу к ней
	// (спецразрешение) — блок
