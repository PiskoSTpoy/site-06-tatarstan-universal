<script lang="ts">
	...
	// После волны 37 в блоге 8 статей о том, что определяет дату выезда крана на объект: семь про
	// наряд-допуск или разрешение на площадку (газоопасная зона, работа у ЛЭП, охранная зона
	// газопровода, периметр ОЭЗ «Алабуга») и одна про допуск на дорогу к ней (спецразрешение) — блок
