<script lang="ts">
	...
	// После волны 41 в блоге 12 статей о том, что определяет дату выезда техники на объект: одиннадцать
	...
	// культурного наследия, охранная зона железной дороги, земляные работы в Казани) и одна про
