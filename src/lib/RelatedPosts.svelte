<script lang="ts">
	...
	// После волны 43 в блоге 14 статей о том, что определяет дату выезда техники на объект: тринадцать
	...
	// зона реки или водохранилища, полоса отвода и придорожная полоса автомобильной дороги) и одна про
